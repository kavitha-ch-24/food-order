...
import { HotelLoginComponent } from './hotel-module/auth/hotel-login/hotel-login.component';
import { CreateItemComponent } from './hotel-module/items/create-item/create-item.component';
...
export const routes: Routes = [
  ...
  { path: 'hotel/login', component: HotelLoginComponent },
  {
    ...
    children: [
      ...
      { path: 'hotel/create-item', component: CreateItemComponent },
    ]
  },
  { path: '**', redirectTo: 'login', pathMatch: 'full' }
];
